 ...
 * 
 * Multiple file upload component with progress-bar, drag-and-drop. © 2010 Andrew Valums ( andrew(at)valums.com )
 * 
...
/**
 * obj2url() takes a json-object as argument and generates a querystring. pretty much like jQuery.param()
 * 
 * how to use:
 * 
...
qq.obj2url = function(obj, temp, prefixDone) {
	var uristrings = [], prefix = '&', add = function(nextObj, i) {
		...
		if ((nextTemp != 'undefined') && (i != 'undefined')) {
			uristrings
					.push((typeof nextObj === 'object') ? qq.obj2url(nextObj, nextTemp, true) : (Object.prototype.toString.call(nextObj) === '[object Function]') ? encodeURIComponent(nextTemp) + '=' + encodeURIComponent(nextObj()) : encodeURIComponent(nextTemp) + '=' + encodeURIComponent(nextObj));
		}
	};
